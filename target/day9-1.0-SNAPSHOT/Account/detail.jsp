...
<div class="container mt-3">
        ...
        <div>
            <c:if test="${sessionScope.fullname != null}">
                <c:if test="${check == 1}">
                    <form method="post">
                        <div>
                            <a class="btn btn-sm" href="unlikeVideo?id=${video.id}">
                ...
                <c:if test="${check == -1}">
                    <div>
                        <a class="btn btn-sm" href="likeVideo?id=${video.id}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
    ...
    <iframe width="100%" height="600" src="${video.poster}" title="YouTube video player" frameborder="0"
